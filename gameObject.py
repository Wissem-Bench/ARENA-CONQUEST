...
class GameObject(pygame.sprite.Sprite) :
    ...
    def init(self):
        self.kharya = pygame.image.load("Assets/Minotaur.png") #.convert()
    ...
    def draw(self):
        self.handler.game.WIN.blit(self.kharya, (1500 - self.handler.game.gameState.current_world.camera.xOffset,120))
